...
export default function LiquidChrome({
  baseColor = [0.8, 0.72, 1.0], // Normalized RGB for --lilac #CDB8FF
  speed = 0.2,
  amplitude = 0.3,
  frequencyX = 3,
  frequencyY = 3,
  ...
  useEffect(() => {
    ...
    try {
      ...
      console.warn('WebGL not supported for LiquidChrome');
      return;
    }
  ...
  }, [baseColor, speed, amplitude, frequencyX, frequencyY, interactive, prefersReducedMotion]);

  if (prefersReducedMotion) {
    return <div className={`bg-lilac border-3 border-ink ${className}`} {...props} />;
  }
