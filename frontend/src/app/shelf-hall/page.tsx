...
const FALLBACK_SHELF_DATA: ShelfPositionDTO[] = [
  ...
  { resourceId: 'res-11', barcode: '621.381 OSC', title: 'Rigol Digital Storage Oscilloscope', authorOrBrand: 'Rigol Technologies', type: 'HARDWARE', status: 'AVAILABLE', clusterId: 3, aisleId: 'AISLE-B1', shelfLevel: 3, posX: -1.2, posY: 2.54, posZ: 0, spineColorHex: '#A4D7E1', isEyeLevel: false },
  { resourceId: 'res-12', barcode: '621.395 FPGA', title: 'Xilinx Artix-7 FPGA Nexys Kit', authorOrBrand: 'Digilent / Xilinx', type: 'LAB_KIT', status: 'BORROWED', clusterId: 3, aisleId: 'AISLE-B1', shelfLevel: 3, posX: -0.82, posY: 2.54, posZ: 0, spineColorHex: '#7DE8A8', isEyeLevel: false },
  { resourceId: 'res-13', barcode: '621.398 RPI', title: 'Raspberry Pi 5 (8GB) Edge Kit', authorOrBrand: 'Raspberry Pi Foundation', type: 'HARDWARE', status: 'AVAILABLE', clusterId: 3, aisleId: 'AISLE-B1', shelfLevel: 3, posX: -0.44, posY: 2.54, posZ: 0, spineColorHex: '#FFE14D', isEyeLevel: false },
  { resourceId: 'res-14', barcode: '621.399 ARD', title: 'Arduino Mega 2560 Sensor Kit', authorOrBrand: 'Arduino Official', type: 'LAB_KIT', status: 'AVAILABLE', clusterId: 3, aisleId: 'AISLE-B1', shelfLevel: 3, posX: -0.06, posY: 2.54, posZ: 0, spineColorHex: '#7DE8A8', isEyeLevel: false },
  { resourceId: 'res-15', barcode: '621.382 DMM', title: 'Keysight 6½ Digit Multimeter', authorOrBrand: 'Keysight Tech', type: 'HARDWARE', status: 'AVAILABLE', clusterId: 3, aisleId: 'AISLE-B1', shelfLevel: 3, posX: 0.32, posY: 2.54, posZ: 0, spineColorHex: '#A4D7E1', isEyeLevel: false },
  { resourceId: 'res-16', barcode: '371.330 SEM', title: 'Capstone Seminar Room 402B', authorOrBrand: 'Campus Library Facilities', type: 'SEMINAR_ROOM', status: 'AVAILABLE', clusterId: 3, aisleId: 'AISLE-B1', shelfLevel: 3, posX: 0.70, posY: 2.54, posZ: 0, spineColorHex: '#FFA8CE', isEyeLevel: false },
];
